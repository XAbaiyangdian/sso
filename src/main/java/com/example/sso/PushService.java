...
public class PushService {
    ...
    public SSOResult pushUser(String mobile, String company, String uscc, String cfcaKeyId, String realName, String idCard) {
        PushUserDto pushUserDto = new PushUserDto(mobile, company, uscc, cfcaKeyId, realName, idCard);
